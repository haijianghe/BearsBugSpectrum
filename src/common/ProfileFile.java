...
public class ProfileFile {
	...
	//change tcPassed and tcFailed,because some dataset of Bears.
	public void incrementPassTestcase(boolean increment)
	{
		if( increment )
		{//passed testcase +1
			tcPassed ++;
	...
	//testcase result from pass to fail, We discard this testcase,because some dataset of Bears.
	public void removeTestcaseChangeToFail()
	{
		tcPassed --;
	}
	...
	public void assembleFromParsedCoverage(MatrixOfClasses clazzMatrix,boolean passed)
	{
		...
		for( ClassLinesHit clHit : cLinesList)
		{
			...
			{
				BearsNullLineClass.addOneClass(clHit.getClassName());
